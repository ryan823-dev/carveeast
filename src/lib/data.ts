...
export const ARTISTS: Artist[] = [
  ...
  // Artist 11 - Jiang Haoxu (Contemporary Seal Carving Educator)
  {
    ...
    primaryDiscipline: Discipline.SEAL_ENGRAVING,
    disciplines: [Discipline.SEAL_ENGRAVING, Discipline.CALLIGRAPHY],
    bio: 'Jiang Haoxu, courtesy name Ruisheng, art name Anjiao Shanren, is the founder of Jinshi Seal Studio (金石印坊). With over 30 years of seal carving experience, he has dedicated more than a decade to seal carving education and the promotion of traditional Chinese seal art. He collaborated with Founder Type to create the "Haoxu Single-Stroke Regular Script" font, and authored "Single-Stroke Regular Script Border Inscriptions: Techniques and Creation." His teaching programs have trained hundreds of students, and he regularly conducts lectures and workshops across China.',
    shortBio: 'Seal carving educator and founder of Jinshi Seal Studio, pioneering single-stroke border inscription style',
    statement: 'Seal carving is not just about cutting stone—it is about transmitting a culture that spans three thousand years. Every student I teach carries this tradition forward.',
    ...
    tags: ['Seal Education', 'Single-Stroke Style', 'Border Inscriptions', 'Cultural Transmission', 'Founder Type Collaboration'],
    isFeatured: true,
    featuredOrder: 9,
    stats: {
      totalWorks: 120,
